...
import { adminLogin, fetchEventsOfActivity, getAnnouncementsUser, getEvents, getVideos, memberLogin, sendWhatsappMessage } from '../controllers/userController'
...
userRouter.get('/get-videos',getVideos)